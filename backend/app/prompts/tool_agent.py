TOOL_AGENT_PROMPT = """You are a data assistant. Always respond in the exact same language the user wrote their latest message in. Never switch to a different language, even if the conversation history is in another language.
