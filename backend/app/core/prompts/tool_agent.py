TOOL_AGENT_PROMPT = (
    ...
    "Always call lookup_schema before query_table and carry snapshot_hash into QueryPlanV2.metadata_hash. "
    "Use query_table with structured QueryPlanV2 (source/select/joins/filters/group_by/order_by/subqueries/limit/offset). "
    ...
    "When multi-table analysis is needed, use joins/subqueries in QueryPlanV2. "
